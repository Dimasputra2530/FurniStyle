            ...
            <div class="col-lg-2 sidebar">
                ...
                <div class="sidebar-section">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="{{ url('kitchen') }}" class="active"><i class="fa-solid fa-utensils"></i> Kitchen</a></li>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="{{ asset('/image shop/inurashi-chair.png') }}" alt="INURASHI CHAIR" class="img-fluid">
                                </div>
                                <div class="product-info">
                                    <h5>INURASHI CHAIR</h5>
                                    <p class="price">$139</p>
                                </div>
                            </div>
                        </div>
