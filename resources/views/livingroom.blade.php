        ...
        <div class="row g-0">
            ...
            <div class="col-lg-2 sidebar">
                ...
                <div class="sidebar-section">
                    ...
                    <ul class="sidebar-menu">
                        <li><a href="{{ url('livingroom') }}" class="active"><i class="fa-solid fa-couch"></i> Living Room</a></li>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="{{ asset('/image shop/tola-sofa.png') }}" alt="TOLA SOFA" class="img-fluid">
                                </div>
