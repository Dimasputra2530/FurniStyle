            ...
            <div class="col-lg-2 sidebar">
                <div class="sidebar-section">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="{{ url('glass-shop') }}" class="active"><i class="fa-solid fa-wine-glass"></i> Glass</a></li>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="{{ asset('/image material/glass1.jpg') }}" alt="NEXUX TABLE" class="img-fluid">
                                </div>
