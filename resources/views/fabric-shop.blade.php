            ...
            <div class="col-lg-2 sidebar">
                <div class="sidebar-section">
                    ...
                    <ul class="sidebar-menu">
                        <li><a href="{{ url('wood-shop') }}"><i class="fa-solid fa-tree"></i> Wood</a></li>
                        <li><a href="{{ url('glass-shop') }}"><i class="fa-solid fa-wine-glass"></i> Glass</a></li>
                        <li><a href="{{ url('fabric-shop') }}" class="active"><i class="fa-solid fa-shirt"></i> Fabric</a></li>
                    </ul>
                </div>
                ...
                <div class="container product-grid">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="{{ asset('/image material/fabric1.jpg') }}" alt="HOIP CHAIR" class="img-fluid">
                                </div>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="{{ asset('/image material/fabric2.jpg') }}" alt="VIRO SOFA" class="img-fluid">
                                </div>
                                <div class="product-info">
                                    <h5>VIRO SOFA</h5>
                                    <p class="price">$645</p>
